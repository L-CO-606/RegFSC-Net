...
from FSC_L_Models import RegFSCNet

parser = ArgumentParser()
parser.add_argument("--modelpath", type=str,
                    # dest="modelpath", default='./L2ss_2_RegFSC_8_Smth_5.0_LR_0.0001/DiceVal_0.7544_Epoch_0300.pth',# LapIRN:923748,
...
model = RegFSCNet(2, 3, start_channel)
