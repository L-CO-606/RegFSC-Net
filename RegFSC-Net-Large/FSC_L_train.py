...
def train():
    ...
    model_dir = './Loss_{}_RegFSCNet_scale_{}_smo_{}_lr_{}/'.format(using_l2,start_channel,smooth,lr)
    csv_name = 'Loss_{}_RegFSCNet_Scale_{}_smo_{}_lr_{}.csv'.format(using_l2,start_channel,smooth,lr)
    f = open(csv_name, 'w')
    with f:
        fnames = ['Turns','DSC']
